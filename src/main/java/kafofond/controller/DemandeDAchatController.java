...
public class DemandeDAchatController {
    ...
    public ResponseEntity<?> listerDemandesAchatParEntreprise(@PathVariable Long entrepriseId, Authentication authentication) {
        try {
            log.info("Liste des demandes d'achat de l'entreprise {} demandée par {}", entrepriseId, authentication.getName());
            ...
            // Utiliser la méthode du service pour récupérer les demandes d'achat
            List<DemandeDAchat> demandes = demandeDAchatService.listerParEntrepriseId(entrepriseId);
