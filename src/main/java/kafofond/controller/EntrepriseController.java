...
public class EntrepriseController {
    ...
    @Operation(summary = "Créer une entreprise",
            description = "Crée une nouvelle entreprise. Accessible uniquement au Super Admin.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Map<String, Object>> creerEntreprise(
        ...
        EntrepriseDTO entrepriseCreee = entrepriseService.creerEntreprise(entrepriseDTO, authentication.getName());
    ...
    @Operation(summary = "Modifier une entreprise",
            description = "Modifie une entreprise existante. Accessible uniquement au Super Admin.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Map<String, Object>> modifierEntreprise(
        ...
        EntrepriseDTO entrepriseModifiee = entrepriseService.modifierEntreprise(id, entrepriseDTO, authentication.getName());
    ...
    @Operation(summary = "Lister toutes les entreprises",
            description = "Liste toutes les entreprises. Accessible uniquement au Super Admin.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Obtenir une entreprise",
            description = "Récupère les détails d'une entreprise via son ID.")
    @ApiResponses(value = {
     ...
     */
    @Operation(summary = "Changer l'état d'une entreprise",
            description = "Active ou désactive une entreprise. Accessible uniquement au Super Admin.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Map<String, Object>> changerEtatEntreprise(
        ...
        EntrepriseDTO entrepriseModifiee = entrepriseService.changerEtatEntreprise(id, etat, authentication.getName());
